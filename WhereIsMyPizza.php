...
//check get the order number from other page or not.
if(empty($_POST['OrderNo'])){
  echo "<script type='text/javascript'>window.location.href = 'MyOrder.php';</script>";  
}      
...
if($count != 1){
    ...
    echo "<script type='text/javascript'>alert('$message');window.location.href = 'MyOrder.php';</script>";
}else
{
    // goto mapview
}
...
<!--            <div id="ordertext"> Order NO.##123456 </br></div>-->
        ...
        <!-- session_start(); -->
        <div id="ordertext"> Order No.
            <?php $orderno = $_POST['OrderNo']; echo $orderno;?>
        </div>
